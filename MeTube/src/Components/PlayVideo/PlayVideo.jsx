...
const PlayVideo = () => {
    ...
    const [commmentData, setCommentData] = useState([]);
    ...
    <div className='play-video'>
      ...
      <div className="publisher">
        ...
        <div>
            ...
            <span>{channelData?value_converter(channelData.statistics.subscriberCount):"1M"} Subcribers</span>
        </div>
